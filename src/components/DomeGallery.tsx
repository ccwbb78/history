import { useEffect, useMemo, useRef, useCallback, type MouseEvent, type PointerEvent } from 'react';
...
function buildItems(pool: DomeImage[], seg: number): ItemSpec[] {
...
export default function DomeGallery({
  ...
  const originalTilePositionRef = useRef<Rect | null>(null);
  ...
  const openItemFromElement = useCallback(
    (el: HTMLElement) => {
      ...
      lockScroll();
      const parent = el.parentElement as HTMLElement;
      focusedElRef.current = el as HTMLDivElement;
